...
async def registration_update_db(db_user_id: int, div_team_str: str, 
    ...
    # Need to know whether the event has divisions or teams
    solo_div_team_id = [add_div_team_id if add_div_team_id is not None else rm_div_team_id][0]
